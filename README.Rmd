...
Each student will submit their HW through their own repo (GitHub classroom). Homework is implemented in R Markdown documents, rendered to HTML, and pushed to GitHub. Students can commit as many times as needed. A basic auto-grading system is implemented in the HW's markdown file for quick feedback.
